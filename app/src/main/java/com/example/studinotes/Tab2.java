...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new Tab2_adapter(mData,mData1,mData2,getActivity());
        ...
        adapter1 = new Tab2_adapter1(mData3,mData4,mData5,getActivity());
       ...
       /* add1.setOnClickListener(new View.OnClickListener() {
        ...
        add1.setOnClickListener(new View.OnClickListener() {
               ...
               /* Dialogtab2_1 cdd = new Dialogtab2_1(getActivity());
    ...
    private void dialogExamCreateDate(){
        ...
        View dialogView = inflater.inflate(R.layout.dialogtab2, null);
    ...
    private void dialogAccessCreateDate(){
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(getActivity());
        LayoutInflater inflater = this.getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.dialogtab2_1, null);
        dialogBuilder.setView(dialogView);
        dialogBuilder.setCancelable(false);
