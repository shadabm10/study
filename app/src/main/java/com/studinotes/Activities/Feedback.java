...
public class Feedback extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        prefrence = new Shared_Preference(Feedback.this);
    ...
    private void initialfunction() {
        ...
        send_suggestion=findViewById(R.id.send_feedback);
    ...
    private void SendSuggestion(final String review) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_DEV +"adduserFeedback", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(Feedback.this, "issue", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Feedback.this, "Exception", Toast.LENGTH_LONG).show();
                pd.dismiss();
            }
        }) {
            @Override
...
// Posting parameters to login url
                ...
                params.put("feedbackText", review);
