...
public class AdapterPDF extends RecyclerView.Adapter<AdapterPDF.PlanetViewHolder> {

    ArrayList<HashMap<String,String>> videoList;    // Context context;
// Context context;
// int [] imageId,imageId1,imageId2,imageId3,imageId4;

    public AdapterPDF(ArrayList<HashMap<String,String>>videoList, Context context) {
        this.videoList = videoList;
    }
    @Override
    public AdapterPDF.PlanetViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterPDF.PlanetViewHolder holder, int position) {
