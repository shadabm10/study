...
public class TimeManagement extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new TimeManagement_adapter(mData,mData1,mData2,mData3,mData4,getActivity());
        recyclerView.setAdapter(adapter);

        RecyclerView recyclerView1 = (RecyclerView) rootView.findViewById(R.id.recycle3);
        mLayoutManager = new LinearLayoutManager(this.getActivity().getBaseContext());
        recyclerView1.setLayoutManager(mLayoutManager);
        adapter1 = new TimeManagement_adapter1(data,data1,data2,getActivity().getBaseContext());
